        ...
        <div class="row mt-5 mx-5">
                ...
                <section class="mb-5" id="section-details">
                    <div class="container-fluid" id="fadeInLeftBig">
                        <div class="row  justify-content-start align-items-center g-2">
                            <div class="col-xl-6 col-lg-12"><img id="front-page-img" src="<?php echo get_template_directory_uri(); ?>/assets/libri.jpg" alt=""></div>
                ...
                <section id="section-details">
                    <div class="container-fluid " id="fadeInRight">
                        <div class="row flex-wrap-reverse justify-content-start align-items-center g-2">
                            <div class="col-xl-6 col-lg-12">
                                <p>Il benessere di viaggiare non riguarda solo noi stessi, ma anche il mondo che ci circonda. Attraverso il turismo responsabile e sostenibile, possiamo contribuire alla conservazione dell'ambiente e al sostegno delle comunità locali. Il viaggiare ci offre l'opportunità di connetterci con la natura, di apprezzare la sua bellezza e di impegnarci nella sua protezione.
                            ...
                            <div class="col-xl-6 col-lg-12"><img id="front-page-img" src="<?php echo get_template_directory_uri(); ?>/assets/fiori.jpg" alt=""></div>
            ...
            <div class="col-12 mb-5">
                <section id="section-details">
                    <div class="container-fluid " id="fadeInLeftBig">
                        <div class="row  justify-content-start align-items-center g-2">
                            <div class="col-xl-6 col-lg-12"><img id="front-page-img" src="<?php echo get_template_directory_uri(); ?>/assets/deserto.jpg" alt=""></div>
                            <div class="col-xl-6 col-lg-12">
                                ...
                                <ul>
                                    ...
                                    <li> Incontro con sé stessi: Il viaggiare è anche un'opportunità per la riflessione e l'auto-esplorazione, permettendoci di scoprire nuove parti di noi stessi e di riconnetterci con i nostri valori e passioni più profonde.</li>
                                    <li>
                                    ...
                                    <li> Sviluppo delle competenze sociali: Interagendo con persone provenienti da diverse culture e contesti, miglioriamo le nostre abilità di comunicazione, empatia e comprensione interculturale.</li>
                ...
                <section id="section-details">
                    <div class="container-fluid " id="fadeInRight">
                        <div class="row flex-wrap-reverse justify-content-start align-items-center g-2">
                            ...
                            <div class="col-xl-6 col-lg-12"><img id="front-page-img" src="<?php echo get_template_directory_uri(); ?>/assets/city.jpg" alt=""></div>
