        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            window.addEventListener('scroll', function() {
                if (window.pageYOffset > 50) {
                    navbar.classList.add('nb2');
                } else {
                    navbar.classList.remove('nb2');
                }
            });
        });
    </script>
                ...
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0 ">
                    ...
                    <li class="nav-item d-flex align-items-center px-3 border-start">
                        <img width="25rem" height="25rem" style="object-fit-cover"
                            src="https://upload.wikimedia.org/wikipedia/commons/thumb/0/03/Flag_of_Italy.svg/2000px-Flag_of_Italy.svg.png"
