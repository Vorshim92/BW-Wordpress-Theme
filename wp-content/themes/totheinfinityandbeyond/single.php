...
<div class="container pt-2 pb-5 ">
    ...
    <img style="width:100% ;max-height:25rem;object-fit:cover"
        src="<?php the_post_thumbnail_url('custom-cover-thumbnail'); ?>" alt="<?php the_title(); ?>">
        ...
        <div class="col-12 col-md-3">
            ...
            <div class="row gy-2  ">
                ...
                $sidebar_posts = new WP_Query(
                    array(
                        'posts_per_page' => 5,
                        'category__in' => $current_post_categories, // Include only posts from the current post's categories
                        'post__not_in' => array($current_post_id) // Exclude the current post from the list
                    )
                );
